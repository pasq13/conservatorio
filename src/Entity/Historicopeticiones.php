 ...
 * Historicopeticiones
 *
 * @ORM\Table(name="historicopeticiones", indexes={@ORM\Index(name="NOMBREADMIN_FK", columns={"NOMBREADMIN"})})
 * @ORM\Entity
 */
class Historicopeticiones
{
    /**
     * @var int
     *
     ...
     * @return  self
     */ 
    public function setValidada(bool $validada)
    {
